...
# Debug mode throws exceptions into the front end to help cdebug the backend during development.
# This must be tyurned off by changing the value of 'DEBUG' variable in django's settings.py.
# The above line of code enables django server ti include the media folder in hosting during debug mode.