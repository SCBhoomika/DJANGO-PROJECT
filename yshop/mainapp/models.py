...
class Product(models.Model):
    ...
    # for the ImageField, sql stores only the relative path of the image, the actual image will be stored
    # in the specified medis server subfolder, in this case, 'products'. Rest of config is in settings.py
    pic = models.ImageField(upload_to = "product/", null = True) # stock INT DEFAULT 1
